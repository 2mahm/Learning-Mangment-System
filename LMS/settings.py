...
SECRET_KEY = os.environ.get(
    'SECRET_KEY',
    'django-insecure-5_8txej&x3d8mboq4v15^51v*7ibs=e13qsawl1&zc4v3bo@(c',
)
...
REST_FRAMEWORK = {
    'DEFAULT_AUTHENTICATION_CLASSES': [
        'accounts.authentication.StudentTokenAuthentication',
...
if os.environ.get('DB_HOST'):
    DATABASES = {
        'default': {
            ...
            'PASSWORD': os.environ.get('DB_PASSWORD', 'lms_secret'),
